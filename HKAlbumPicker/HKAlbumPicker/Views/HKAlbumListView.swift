...
class HKAlbumListView: UIView {
    ...
    lazy var tableView: UITableView = {
        let tableV = UITableView.init(frame: CGRect(x: 0, y: 0, width: YX_AppW(), height: 400), style: .plain)
        tableV.backgroundColor = YX_Color16(0xF5F5F5)
        
        tableV.delegate = self
        tableV.dataSource = self
        tableV.separatorStyle = .none
        tableV.register(HKAlbumListCell.self, forCellReuseIdentifier: "HKAlbumListCell")
